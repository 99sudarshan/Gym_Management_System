...
const MemberReportTable = ({ membersCount, page }) => {
  return (
    <>
      {/* Table */}
                    ...
                    membersCount.map((item, index) => {
                      return (
                        ...
                        >
                          ...
                          <td className="table_body ">{item.day}</td>
                          <td className="table_body ">{item.guest}</td>
                          <td className="table_body ">{item.valid}</td>
                          <td className="table_body ">
